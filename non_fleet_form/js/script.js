 $(document).ready(function(){
  ...
  $('.save').click(function(){
	...
	var schedule_yestest =$("#schedule_yes").prop('checked');
		if( schedule_yestest == true){
		var schedule_yes = "checked";
	}else{
		var schedule_yes = "false";
	}
		var schedule_notest =$("#schedule_no").prop('checked');
		if( schedule_notest == true){
		var schedule_no = "checked";
	}else{
		var schedule_no = "false";
	}
		var loaned_yestest =$("#loaned_yes").prop('checked');
		if( loaned_yestest == true){
		var loaned_yes = "checked";
	}else{
		var loaned_yes = "false";
	}	
		var loaned_notest =$("#loaned_no").prop('checked');
		if( loaned_notest == true){
		var loaned_no = "checked";
	}else{
		var loaned_no = "false";
	}	
		var canceled_yestest =$("#canceled_yes").prop('checked');
		if( canceled_yestest == true){
		var canceled_yes = "checked";
	}else{
		var canceled_yes = "false";
	}	
		var canceled_notest =$("#canceled_no").prop('checked');
		if( canceled_notest == true){
		var canceled_no = "checked";
	}else{
		var canceled_no = "false";
	}		
...
var dataform=	$('.dataform').find('select, textarea, input').serialize();
 ...
 var applicant_sig=$("#applicant_sig").val();
