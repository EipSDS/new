...
<body>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" style="border-right: 1px solid #000000;">
                                                                                    ...
                                                                                    <table align="left" cellpadding="6" cellspacing="0">
                                                                                        <tr>
                                                                                            <td align="center">
                                                                                                <input type="text" name="City" class='City' id="City" value="<?php echo $garaging_City; ?>" style="width:113px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                            <td align="center">
                                                                                                <input type="text" name="State" class='State' id="State" value="<?php echo $garaging_State; ?>" style="width:113px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                            <td align="center">
                                                                                                <input type="text" name="Zip" class='Zip' id="Zip" value="<?php echo $garaging_ZIP_Code; ?>" style="width:113px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="border: 2px solid #000000;">
                                                                        ...
                                                                        <table align="left" width="142" cellpadding="6" cellspacing="0">
                                                                            <tr>
                                                                                <td align="center">
														<input type="text" name="limit" class="limit" id="limit" value="<?php echo $row55['cargo_limit']; ?>" width="100%"  style="width:100%;border: 0;font-size:14px;" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table align="left" width="100%" cellpadding="6" cellspacing="0" bgcolor="#fff" style="font-size:12px;border: 1px solid #000000;">
                                                                            <tr>
                                                                                <td align="left">
                                                                                    Does the applicant have any owned, leased or operated equipment not listed on the vehicle schedule?
                                                                                    <input type="checkbox" name="schedule_yes" value="" class="schedule" id="schedule_yes" <?php echo $row67[ 'schedule_yes']; ?>> Yes
                                                                                    <input type="checkbox" name="schedule_no" value="" class="schedule" id="schedule_no" <?php echo $row67[ 'schedule_no']; ?>> No
                                                                                </td>
                                                                                <script>
                                                                                    $(document).ready(function() {
                                                                        ...
                                                                        <table align="left" width="100%" height="32px" cellpadding="6" cellspacing="0" bgcolor="#eeeeef" style="font-size:12px;border: 1px solid #000000;">
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <input type="checkbox" name="loaned_yes" value="yes" class="schedule2" id="loaned_yes" <?php echo $row67[ 'loaned_yes']; ?>> Yes
                                                                                    <input type="checkbox" name="loaned_no" class="schedule2" id="loaned_no" <?php echo $row67[ 'loaned_no']; ?>> No
                                                                                </td>
                                                                                <script>
                                                                                    $(document).ready(function() {
                                                                        ...
                                                                        <table align="left" width="100%" height="32px" cellpadding="6" cellspacing="0" bgcolor="#eeeeef" style="font-size:12px;border: 1px solid #000000;">
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <input type="checkbox" name="canceled_yes" value="" class='canceled' id="canceled_yes" <?php echo $row67[ 'canceled_yes']; ?>> Yes
                                                                                    <input type="checkbox" name="canceled_no" value="" class='canceled' id="canceled_no" <?php echo $row67[ 'canceled_no']; ?>> No
                                                                                </td>
                                                                                <script>
                                                                                    $(document).ready(function() {
	...
	your protection, the preceding states’ laws require the following to appear on this form:</b> Any person who knowingly, and with intent to defraud any insurance company or other person, files an application for insurance or statement of claim containing any materially false, incomplete, or misleading information, or conceals information concerning any material fact thereto, commits a fraudulent insurance act, which is a crime punishable by incarceration, and shall also be subject to civil penalties.
                                                        </td>
                                                    </tr>
                                                    <table width="100%" align="center" height="10" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:12px;">
                                                            <b>For risks located in New York, Pennsylvania, and California: </b> Any person who knowingly makes or assists, abets, solicits or conspires with another to make a false or misleading reports or the theft, destruction, damage or conversion of any motor vehicle to a law enforcement agency, a state department of motor vehicles, or an insurance company, commits perjury or a fraudulent insurance act, which are crimes punishable by incarceration, and shall also be subject to a civil penalty.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:12px;">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <table width="50%" align="left" height="10" cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <input type="submit" name="submit" onclick="myFunction()" value="Print" style="background: #004d96;color: #fff;border: 0;padding: 10px 35px;text-transform: capitalize;" />
                                                                                    </td>
                                                                                </tr>
                                                                                <script>
                                                                                    function myFunction() {
                                                                            ...
                                                                            <table width="50%" align="right" height="10" cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td align="right">
                                                                                        <input type="button" class="action-button save" value="save" style="background: #004d96;color: #fff;border: 0;padding: 10px 35px;text-transform: capitalize;" />
