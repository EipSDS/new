...
<table align="left" cellpadding="6" cellspacing="0">
	...
	<tr>
	<td>
	<input type="text" name="Tractors1" class='tractors' id="tractors1" value="test" width="100%" style="width:100%;border: 0;font-size:14px;"/>
	</td>
	</tr>
	</table>
	</td>
	...
	<tr>
	<td>
	<input type="text" name="VIN1" class='vin' id="vin1" width="100%"  value="<?php echo $row3['vehicle_type']; ?>" style="width:100%;border: 0;font-size:14px;"/>
	</td>
	</tr>
	</table>
	</td>
