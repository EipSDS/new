...
$query3 = "SELECT * FROM public.contact_vehicles where contact_id='4098623000001221042' AND vehicle_type='Trailer'";
...
echo $arrmake[3];
echo "===========================";
$query5 = "SELECT * FROM public.contact_vehicles where contact_id='4098623000001221042' AND vehicle_type !='Trailer'";
