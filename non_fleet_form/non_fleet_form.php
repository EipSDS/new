                                                                            ...
                                                                            <tr>
                                                                                <td align="left" style="border-right: 1px solid #000000;">
                                                                                    ...
                                                                                    <table align="left" cellpadding="6" cellspacing="0">
                                                                                        <tr>
                                                                                            <td align="center">
                                                                                                <input type="text" name="City" class='City' id="City" value="<?php echo $garaging_City; ?>" style="width:140px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                            <td align="center">
                                                                                                <input type="text" name="State" class='State' id="State" value="<?php echo $garaging_State; ?>" style="width:140px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                            <td align="center">
                                                                                                <input type="text" name="Zip" class='Zip' id="Zip" value="<?php echo $garaging_ZIP_Code; ?>" style="width:140px;border: 0;font-size:14px;" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
